...
<body class="flex flex-col items-center mt-10 md:mt-20">
    <div class="w-[80%] p-5 border shadow-xl">
        <form action="#" method="POST" enctype="multipart/form-data">
            <h1 class="font-bold text-3xl uppercase">Ajouter Tâche</h1>
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                <div>
                    <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Nom tâche</label>
                    <input name="nomtache" type="text" name="name" id="name"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        placeholder="Nom de votre tâche" required="">
                </div>
                <div>
                    <label for="category"
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="4"
                        ...
                        placeholder="Ecrire ici la description de votre tâche"></textarea>
                </div>
            </div>
            <button type="submit"
                name="submit"
